                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <select name="type" id="type"  required="required" style="width:19%">
                            ...
                            $sql = "SELECT type FROM `name`  ORDER BY id DESC LIMIT 1";     // get last saved item value in database in dropdown
...
<!--second from for loading type dropdown both in database and in fronted dropdown -->
...
$res = mysqli_query($conn,$sql);
$sql .= " ORDER BY vrijeme DESC";   //sort by the time created from last one to first one
...
// second form for adding type in  type-table database and in fronted dropdown
